...
def load_config(*, require_services: bool = True) -> AppConfig:
    ...
    return AppConfig(
        ...
        preprocessor_poll_timeout_s=_int(os.getenv("PREPROCESSOR_POLL_TIMEOUT_SECONDS"), 3600),
        preprocessor_request_timeout_s=_int(os.getenv("PREPROCESSOR_REQUEST_TIMEOUT_SECONDS"), 30),
        preprocessor_transient_error_limit=_int(os.getenv("PREPROCESSOR_TRANSIENT_ERROR_LIMIT"), 5),
        inference_poll_timeout_s=_int(os.getenv("INFERENCE_POLL_TIMEOUT_SECONDS"), 7200),
        ...
        trait_extraction_request_timeout_s=_int(os.getenv("TRAIT_EXTRACTION_REQUEST_TIMEOUT_SECONDS"), 30),
